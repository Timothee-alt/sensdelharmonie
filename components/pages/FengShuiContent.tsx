      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="fengshui-hero relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-playfair font-bold title-color leading-tight title-color">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {fiveElements.map((element, index) => (
              ...
              >
                ...
                <div className="text-xs text-gray-500 bg-sage-100 rounded-full px-3 py-1">
                  {element.areas}
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-2xl mx-auto mb-12">
            {baguaDomains.map((domain, index) => (
              ...
              >
                <domain.icon className="w-8 h-8 text-gray-500 mx-auto mb-3" />
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl max-w-4xl mx-auto"
          >
            <div className="text-center space-y-4">
              <Compass className="w-12 h-12 title-color mx-auto" />
              <h3 className="text-xl font-playfair font-bold text-sage-800 title-color">
